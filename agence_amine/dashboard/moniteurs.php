...
<main class="container my-5">
    ...
    <div class="card-table">
        ...
        <a href="/dashboard/utils/ajouter_moniteur.php" class="btn btn-success mb-3">Ajouter un Moniteur</a>
                    ...
                    <?php else : ?>
                        <?php foreach ($moniteurs as $moniteur) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/utils/modifier_moniteur.php?id=<?= urlencode($moniteur['ID_MONITEUR']); ?>" class="btn btn-warning btn-sm">Modifier</a>
